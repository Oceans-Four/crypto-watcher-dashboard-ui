        ...
        <div className="col-xl-12">
          <div className="card">
            <div className="card-header pb-0 d-block d-sm-flex flex-wrap border-0 align-items-center">
              ...
              <Link
                to={"#"}
                className="btn btn-primary light btn-rounded me-3  mb-3"
              >
              ...
              <div className="row sp20 mb-4 align-items-center">
                <div className="col-xxl-8 d-flex flex-wrap justify-content-between align-items-center">
                  <div className="px-2 info-group">
                    ...
                    <h2 className="fs-28 font-w600 text-black">$17,741.55</h2>
                  </div>
                  <div className="px-2 info-group">
                  ...
                  <div className="px-2 info-group">
                    ...
                    <h3 className="fs-20 font-w600 text-black">$56.75B</h3>
                  </div>
                  <div className="px-2 info-group">
                    <p className="fs-14 mb-1">Market Cap</p>
                    <h3 className="fs-20 font-w600 text-black">$874.11B</h3>
                  </div>
                </div>
                  ...
                  <div className="col-xl-12">
                    <div className="d-flex flex-wrap justify-content-between mb-1">
                      ...
                      <div className="text-muted">
                        {" "}
                        1 BST = 55409.56000000 NSE
                      </div>
                    </div>
                    <div className="d-flex flex-wrap justify-content-between">
                      <div>Inverse Price</div>
                      <div className="text-muted"> 1 NSE = 0.00001804 NSE</div>
                    </div>
                  </div>
                </div>
                <button
