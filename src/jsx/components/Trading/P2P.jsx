              ...
              <div className="card-header border-0">
                ...
                <nav>
                  <Nav
                    ...
                    role="tablist"
                  >
                    <Nav.Link as="button" eventKey="Buy" type="button">
                      Buy
                    </Nav.Link>
                    <Nav.Link as="button" eventKey="Sell" type="button">
                      Sell
                    </Nav.Link>
                  </Nav>
                </nav>
                    ...
                    <Tab.Container defaultActiveKey="BTH">
                      <div className="d-flex align-items-center justify-content-between">
                        ...
                        <Nav className="order nav nav-tabs">
                          <Nav.Link as="button" eventKey="BTH" type="button">
                            BTH
                          </Nav.Link>
                          <Nav.Link as="button" eventKey="ETH" type="button">
                            ETH
                          </Nav.Link>
                          <Nav.Link as="button" eventKey="BNB" type="button">
                            BNB
                          </Nav.Link>
                        </Nav>
                      </div>
