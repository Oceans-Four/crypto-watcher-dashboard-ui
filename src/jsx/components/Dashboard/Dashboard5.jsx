          ...
          <div className="card">
            <div className="card-header">
              ...
              <ul className="box-controls pull-right">
                <li>
                  <Link to={"#"} className="box-btn-fullscreen"></Link>
                </li>
              </ul>
            </div>
            ...
            <div className="card-body pt-0 custome-converter">
              ...
              <div className="d-flex justify-content-between align-items-center custome-refresh">
                ...
                <span className="text-black">
                  ...
                  >
                    <g data-v-14e1c52e="" data-name="Layer 2">
                      <g data-v-14e1c52e="" data-name="Layer 1">
                        <path
                          data-v-14e1c52e=""
                          fill="#fcf4a0"
                  ...
                  <tbody>
                    {sellTableData.map((item, ind) => (
                      <tr key={ind}>
                        <td>82.3</td>
                        <td>
                          <i className="fa-brands fa-bitcoin text-warning me-2"></i>{" "}
                          0.15
                        </td>
                        <td>$ 134.7</td>
                      </tr>
