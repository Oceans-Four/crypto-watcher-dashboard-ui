        ...
        <div className="col-xl-6 col-xxl-6">
          <div className="card">
            <div className="card-body d-flex align-items-center">
              ...
              <div className="ms-3">
                <h2 className="text-black fs-20 mb-0 font-w600">
                  Digital Cash
                </h2>
                <span>
                  ETH (USD) = $148.46 (
          ...
          <div className="card">
            <div className="card-body d-flex align-items-center">
              ...
              <div className="ms-3">
                ...
                <span>
                  BTC (USD) = $45.81 (
                  <span className="text-success">+12.24%</span>)
                </span>
              </div>
            </div>
              ...
              <ul className="list-group list-group-flush">
                <li className="list-group-item d-flex px-0 justify-content-between align-items-center">
                  ...
                  <div className="w-100 ms-3">
                    <div className="d-flex justify-content-between align-items-center">
                      ...
                      <span className="ms-auto fs-15 mb-0  text-black font-w600">
                        $10,245.00
                      </span>
                    </div>
                    <div className="d-flex justify-content-between align-items-center">
                      <span className="text-success tx-13">
                        <i className="fa fa-caret-up me-1"></i>2.04%
                      </span>
                ...
                <li className="list-group-item d-flex px-0 justify-content-between align-items-center">
                  ...
                  <div className="w-100 ms-3">
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                      <span className="text-danger tx-13">
                        <i className="fa fa-caret-down me-1"></i>1.25%
                      </span>
